      ...
      <div className="sidebar">
        <nav className="mt-2">
          ...
          >
            {/* Dashboard Menu */}
            <li
              className={`nav-item ${menuState.dashboard ? "menu-is-opening menu-open" : ""}`}
            >
              <a
                href="#"
            ...
            {/* Products Menu */}
            <li
              className={`nav-item ${menuState.Products ? "menu-is-opening menu-open" : ""}`}
            >
              <a
                href="#"
                className="nav-link"
            ...
            {/* Department Menu */}
            <li className="nav-item">
              <Link to="/department-list" className="nav-link">
